...
def test_saha_big_graph():
    ...
    graph.add_edges_from(np.load('tests/saha/files/graph_big_cardinality_image.npy'))
...
def test_saha2():
    graph = nx.fast_gnp_random_graph(1000, 0.05)
    ...
    print((407, 525) in graph.edges)
    qb2 = update_rscp(qblocks, vertexes, (407, 525))
